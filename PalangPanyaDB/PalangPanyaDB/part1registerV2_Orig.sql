...
/* Created on:     4/6/2016 10:57:43 AM                         */
/*==============================================================*/
...
alter table ini_list_zip
   add constraint fk_inizip_subd foreign key (province_code, country_code, district_code, subdistrict_code)
      references ini_subdistrict (province_code, country_code, district_code, subdistrict_code)
go
...
alter table member
   add constraint fk_member_reference_ini_list foreign key (province_code, country_code, district_code, subdistrict_code, zip_code)
      references ini_list_zip (province_code, country_code, district_code, subdistrict_code, zip_code)
go
